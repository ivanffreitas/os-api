...
public class ClienteResource {
	...
	// recebe os dados de um cliente vindo da class ClienteService para ser exibida
	@GetMapping(value = "/{id}")
	...
	// recebe os dados cliente vindo da class ClienteService para ser exibida
	@GetMapping
	...
	//PASSAR DADOS PARA O ClienteService INSERIR NA BASE DE DADOS
		@PostMapping
